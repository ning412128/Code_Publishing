...
from utils.ansible2.callback import AdHocResultCallback, PlaybookResultCallBack, CommandResultCallback
from utils.ansible2.exceptions import AnsibleError
...
class AdHocRunner(object):
    ...
    def run(self, tasks, pattern="all", play_name='Ansible Ad-hoc', gather_facts='no'):
        """
